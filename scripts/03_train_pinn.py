...
from lng_pinn.pinn import INPUT_DIM, OUTPUT_DIM, Scaler, train
...
def main() -> None:
    ...
    parser.add_argument("--n-col",      type=int,   default=10_000,
                        help="Number of physics collocation points")
    ...
    train(X, y, X_col, scaler,
          n_steps=args.steps, batch_size=args.batch, lr=args.lr,
